...
const messages = defineMessages({
  menuItemsHeader: {
    ...
    defaultMessage: 'Itens do menu',
  },
  addMenuPath: {
    id: 'dropdownmenu-add-rootpath',
    defaultMessage: 'Adicionar caminho do menu',
  },
  deleteMenuPath: {
    id: 'dropdownmenu-delete-menupath',
    defaultMessage: 'Excluir caminho do menu',
  },
  deleteButton: {
  ...
  addMenuItem: {
    ...
    defaultMessage: 'Adicionar item ao menu',
  },
  moveMenuItemUp: {
    id: 'dropdownmenu-move-menuitem-up',
    defaultMessage: 'Mover item para cima',
  },
  moveMenuItemDown: {
    id: 'dropdownmenu-move-menuitem-down',
    defaultMessage: 'Mover item para baixo',
  },
  emptyActiveMenuPath: {
    id: 'dropdownmenu-emptyActiveMenuPath',
    defaultMessage: 'Selecione um caminho do menu',
  },
  emptyActiveMenuItem: {
    id: 'dropdownmenu-emptyActiveMenuItem',
    defaultMessage: 'Selecione um item do menu',
  },
});
                    ...
                    <Grid>
                      ...
                      >
                        ...
                        <TextWidget
                          ...
                          onChange={(id, value) => {
                            menuConfiguration[activeMenu].title = value;
                          }}
                        />
                        <Form.Field
                          inline
