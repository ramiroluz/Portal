...
const VereadoresListView = (content) => {
  const [tab, setTab] = useState(1);
    // 🛠️ Rola para o topo ao abrir a tela
  useEffect(() => {
    if(window !== undefined)
    window.scrollTo(0, 0);
  }, []);
  return (
    <article>
      ...
      <div className="background-color-cinza py-32">
          ...
          <div className="mt-24">
            <div className="flex grid-cols-3 gap-16 grid-cols-mb-1">
              <div className="item stack row card-default item-vereador">
                <div className="thumbnail max-w-161 min-w-161 border-right-none">
                    <Link to="/vereadores/teste">
                      <img src="/images/vereadores/Alexandre%20Leprovost.png" alt=""
                           className="aspect-ratio-161-179 border-right-none"/>
                    </Link>
                </div>
                <div className="infos stack flex-between px-16 py-16">
                  <h3 className="fs-16 fw-600 fs-montserrat mb-16 lh-normal">
                  Alexandre Leprevost (União)
                  </h3>
                  <div className="context ">
                    <div className="stack gap-10 align-items-start">
                      ...
                      <Link className="button-vereador" to="/vereadores/teste">
                        Saiba Mais
                      </Link>
                    </div>
                  </div>
