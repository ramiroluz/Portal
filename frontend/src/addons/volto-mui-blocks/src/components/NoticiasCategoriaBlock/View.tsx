                                ...
                                <div className="mt-16">
                                    ...
                                    <div className="mt-16">
                                        <p className="mt-16 mb-0 fs-18 ff-lato">
                                            A Câmara debate soluções para reduzir filas e garantir agilidade no
                                            atendimento,
                                            com
                                            medidas que incluem a digitalização de prontuários e o aumento de
                                            profissionais.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="mt-16">
                                        <h2 className="title-32">
                                            Vereadores Criam Fórum para Debater Inclusão Social da Juventude
                                        </h2>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div className="card-default px-24 py-24">
                                            <a href="#">
                                                <h3 className="fs-24 text-black fw-600">
                                                    Curitiba Avança com Projeto de Cidade Inteligente para Melhorar
                                                    Serviços Públicos
                                                </h3>
                                            </a>
                                        </div>
                                ...
                                <div className="item">
                                    <div className="flex gap-16">
                                        ...
                                        <div className="card-default px-24 py-24">
                                            <a href="#">
                                                <h3 className="fs-24 text-black fw-600">
                                                    Comissão de Constituição e Justiça Avalia Nova Proposta de Reforma
                                                    Tributáriat
                                                </h3>
                                            </a>
                                        </div>
            ...
            <span>
              03.
                                        ...
                                        <div className="card-default px-24 py-24">
                                            <a href="#">
                                                <h3 className="fs-24 text-black fw-600">
                                                    Sessão Plenária Homenageia Personalidades que Contribuíram para o
