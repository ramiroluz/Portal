      ...
      <div className="py-30">
        <div className="container">
          <div className="top-vereador flex gap-24 align-items-center flex-column-mb">
            <img src="/images/single/Alexandre%20Leprevost.png" alt="" className="aspect-ratio-1-1 d-mb-none"/>
            <div className="info">
              <div className="flex gap-16 align-items-center flex-column-mb">
                <h1 className="fs-30 fw-600 lh-normal mb-0 fs-mb-24">Vereador {content?.title} • União Brasil (União) </h1>
                <img src="/images/single/Alexandre%20Leprevost.png" alt="" className="aspect-ratio-1-1 d-none d-mb-block"/>
          ...
          <div className="grid-vereador gap-32">
            <div className="card-default py-24 px-24 px-mb-16 py-mb-16">
...

              {
                tab === 0 && (
                  <div className="mt-16 fs-16 fw-400 fs-lato space-16 child lh-normal context">
                    <p>
                      ”Alexandre Leprevost está no primeiro mandato na Câmara Municipal de Curitiba (CMC) e foi eleito, em
                      2020, com 4.385 votos pelo Solidariedade.”
                    </p>
                    <p>
                      Filho de Jussara e Luiz Antônio Leprevost e irmão do deputado federal licenciado e secretário da
                      Justiça, Família e Trabalho do Paraná, Ney Leprevost, Alexandre Leprevost é natural da capital
                      paranaense e pai de Enrico.
                    </p>
                    <p>
                      Empresário desde os 16 anos, o vereador construiu sua carreira no ramo da gastronomia e
                      entretenimento. Suas empresas geram cerca de 100 empregos diretos e atualmente abriu mão da gestão
                      para se dedicar ao mandato parlamentar.
                    </p>

                    <p>
                      Em 2020, sua primeira disputa eleitoral, foi eleito para uma das 38 cadeiras no Legislativo com
                      4.385
                      votos, pelo partido Solidariedade. Além de fazer um mandato participativo, Alexandre Leprevost quer
                      aplicar seus conhecimentos e experiência da vida privada na pública, prezando pela transparência e
                      comprometimento com Curitiba.
                    </p>

                    <p>
                      Suas principais pautas são saúde, esporte, turismo, empreendedorismo e tecnologia. "Com um mandato
                      inovador podemos buscar mais qualidade de vida aos curitibanos", compromete-se.
                    </p>
                    ...
                    <p>
                      ...
                      Alexandre Leprevost; Curitiba (PR), 8/11/1983
                    </p>
...

              {
                tab === 1 && (
                  <div className="mt-16 fs-16 fw-400 fs-lato space-16 child lh-normal context">
                    ...
                    <p>
                      <strong>Frentes parlamentares das quais participa:</strong>
                    </p>
                    <ul>
                      <li>
                        FP do Samba, do Carnaval e das Políticas Culturais
                      </li>
                      <li>
                        FP em Defesa dos Taxistas
                      </li>
                      <li>
                        FP da Nova Concessão do Transporte
                      </li>
                    </ul>

                    <p>
                      <strong>Liderança ou função específica:</strong><br/>
                    </p>
                    <ul>
                      <li>
                        Líder do União
                      ...
                      <li>
                        Presidente da FP em Defesa dos Taxistas
                      </li>
                      <li>
                        Vice-presidente da FP do Samba, do Carnaval e das Políticas Culturais
                      </li>
                    </ul>

                    <p>
                      <strong>
                        Resultados eleitorais:<br/>
                      </strong>
                      2020 (4.385 votos - Solidariedade)
                    </p>

                    <p>
                      <strong>
                        Alterações de filiação partidária na atual legislatura:<br/>
                      </strong>
                      Eleito pelo Solidariedade em 2020, migrou para o União Brasil durante a janela partidária de 2024.
                    </p>
                  </div>
                )
              }
...

              {
                tab === 2 && (
                  <div className="mt-16 fs-16 fw-400 fs-lato space-16 child lh-normal context">
                    <p>
                      <strong>Gabinete:</strong> Anexo 1, 2º andar, sala 1, com acesso pela praça Eufrásio Correia.
                    </p>
                    <p>
                      <strong>Telefone:</strong> 3350-4573 (Ramais 4573 a 4578)
                    </p>
                    <p>
                      <strong>E-mail:</strong> alexandre.leprevost@cmc.pr.gov.br
                    </p>
                    <p>
                      <strong>Site:</strong> -
                    </p>
            ...
            <div className="sidebar stack gap-24">
              <h2 className="fs-24 fw-600 mb-0 fs-mb-20 lh-mb-26">
                Notícias sobre<br/> Alexandre Leprevost
              </h2>
