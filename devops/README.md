...
```
DEPLOY_ENV=prod
DEPLOY_HOST=srv710292.hstgr.cloud
DEPLOY_PORT=22
DEPLOY_USER=plone
DOCKER_CONFIG=.docker
STACK_NAME=camara-de-curitiba-example-com
```
...
prod:
  hosts:
    srv710292.hstgr.cloud:
      ansible_user: root
      host: camara-de-curitiba
      hostname: srv710292.hstgr.cloud
```
...
Deploy the stack defined in `devops/stacks/srv710292.hstgr.cloud.yml` to the remote server with:
